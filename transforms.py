...
class DropEdges:
    ...
    def __call__(self, data):
        ...
        edge_index = dropout_edge(edge_index, p=self.p, training=True)[0]
...
def get_graph_drop_transform(drop_edge_p, drop_feat_p, do_reverse):
    transforms = list()
    ...
    if do_reverse:
        transforms.append(ReverseEdges())
