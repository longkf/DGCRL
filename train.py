...
from utils import set_random_zeros_by_proportion, add_gaussian_noise
...
def link_test():
    ...
    # torch.save(pred, args.save_path + 'DGCRL_N4_pred.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder_hidden_channels', type=int, default=128)
    ...
    parser.add_argument('--link_epochs', type=int, default=200)
    ...
    for run in range(args.runs):
        ...
        data = dataset[0]
        print(data)
        data.x = set_random_zeros_by_proportion(data.x, 0.0)
        ...
        torch.save(roc_result, './save/roc_n3.pt')
        torch.save(loss_result, './save/loss_n3.pt')
